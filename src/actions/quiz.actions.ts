...
import { createQuizFromFile, createQuizFromScratch, newQuiz } from "../controllers/quiz/newQuiz.controller";
...
export const registerQuizActions = (bot: Telegraf<Context<Update>>) => {
    ...
    bot.action(/CREATE_QUIZ_FROM_FILE/, createQuizFromFile)
    bot.action(/CREATE_QUIZ_FROM_SCRATCH/, createQuizFromScratch)
